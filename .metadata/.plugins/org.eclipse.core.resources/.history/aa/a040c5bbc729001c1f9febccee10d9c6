		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(nomeUsuario.getText().equals("") && (new String(senhaUsuario.getPassword()).equals(""))) {
					...
					System.out.println("Por favor, digite o nome e a senha do seu usuário.");
					JOptionPane.showMessageDialog(null, "Por favor, informe o nome do seu usário e sua senha", "Atenção!!", JOptionPane.PLAIN_MESSAGE);
					
				} else if(nomeUsuario.getText().equals("")) {
					
					System.out.println("Digite o nome do seu usuário.");
					JOptionPane.showMessageDialog(null, "Digite o nome do seu usuário.", "Atenção!!", JOptionPane.PLAIN_MESSAGE);
					...
					JOptionPane.showMessageDialog(null, "Credenciais inválidas", "Atenção!!", JOptionPane.PLAIN_MESSAGE);
